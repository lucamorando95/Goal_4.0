...
#    #Devo camboare parametri trasformazione rispetto codice in image_analysis ---> capire perche cambia la trasformazione
    lower_blue = np.array([90,30,0], np.uint8)  #Valori pannello in lab [80,0,40]
    upper_blue = np.array([130,100,100], np.uint8) #[160,100,220]
   ...
   # print(thresh.shape)
    ...
    #         thresh[jj][ii] = 0
    if debug_image_publication:
        publish_img_first_threshold(thresh)
