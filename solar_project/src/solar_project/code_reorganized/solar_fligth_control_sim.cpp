...
void navigation(Panel *panel, PID * pid_x, PID * pid_y, PID * pid_z, PID *pid_yaw)
{
   ...
   */
   ...
   if(drone.flagDroneThermoControlPoint1 == true && drone.flagDroneThermoControlPoint2 ==true && mission.panel_array_initialization == false || drone.image_control_count < 50)
   {
   ...
   if(drone.flagDroneRGBControlPoint1 == true && drone.flagDroneRGBControlPoint2 == true && mission.panel_array_initialization == false || drone.image_control_count < 50)
   {
...
int main(int argc, char** argv)
{
   ...
   //PARAMETRS 
    ...
    waypoints.delta =  0.5; //Traslational error along x respect panel frame located in panel 1
    ...
    Eigen::Vector2f panel_center_W(6.37, 2);
