...
folder = '/home/lucamora/PHD/paper_for_journal_publication/Test_data/Test_Predosa/Exp_5';
...
a_est_GF = a_est_GF(1:6631);
a_est_GF(1885) = 0;
c_est_GF = c_est_GF(1:6631);
% a_est_GF(1885) = 0;
...
GPS_true_path_x = [-36.0779, 48.4964];
GPS_true_path_y = [12.3189, 12.332];
% 
x_pos = x_pos(1:6458);
y_pos = y_pos(1:6458);
...
mean_error_nav =mean(abs(err_y(1883:6427)))
std_error_nav = std( abs(err_y(1883:6427)))
...
folder = '/home/lucamora/PHD/paper_for_journal_publication/Test_data/Test_Predosa/Variable_from_matlab_ws/Both_camera_vision_error';
load(folder)
...
Both_error_from_vision_line = Both_error_from_vision_line(1:6529);
mean_e = mean(abs(Both_error_from_vision_line(1893: end)))
std_e = std(abs(Both_error_from_vision_line(1893: end)))
figure
...
% Navigation Error = 0.2408 +- 0.2290
% Control Error =0.1304 +-   0.0975
