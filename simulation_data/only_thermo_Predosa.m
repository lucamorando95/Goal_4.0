...
folder = '/home/lucamora/PHD/paper_for_journal_publication/Test_data/Test_Predosa/Exp_4';
...
GPS_true_path_x = [-1.37, x_pos(end)];
GPS_true_path_y = [0.0351, 0.0545];
% 
% x_pos = x_pos(1:6183);
% y_pos = y_pos(1:6183);
% 
...
mean_error_nav =mean( abs(err_y(1000:end)))
std_error_nav = std( abs(err_y(1000:end)))



folder = '/home/lucamora/PHD/paper_for_journal_publication/Test_data/Test_Predosa/Variable_from_matlab_ws/Only_THERMO_vision_error';
load(folder)
...
mean_e = mean(abs(Thermo_error_from_vision_line(1000: end)))
std_e = std(abs(Thermo_error_from_vision_line(1000: end)))
figure
...
% Navigation Error =  0.3091 +-  0.1956
% Control Error =0.1484 +-  0.1096
