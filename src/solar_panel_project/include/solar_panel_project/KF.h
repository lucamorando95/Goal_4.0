...
class KF
{
    ...
    void EKF_calculate(float target_point_P1_x,  float target_point_P1_y, float target_point_P2_x,  float target_point_P2_y, float obs_points_P1_x, float obs_points_P1_y ,float obs_points_P2x, float obs_points_P2_y,  
