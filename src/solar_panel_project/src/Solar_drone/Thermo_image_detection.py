...
class Image_THERMO_elaboration:
                ...
                if cv2.contourArea(cnt) < 500000 and cv2.contourArea(cnt) > self.th_3/3:
                 # print('th2_value:  {0}, th3_value: {1}'.format(th2_value, th3_value))
                  ...
                  # print('m_final: ', m_final)
                    print("self.righty: {}, self.lefty: {}: ".format(self.righty, self.lefty))
    ...
    def voting_technique(self, line_versors, line_versors_old, thresh):
        ...
        return  point_line_distance_actual, mean_lines_distance_from_center_line, line_points
            ...
            #                self.point_line_distance_actual.append(dis) 
            
            # if (math.isnan(np.mean(self.point_line_distance_actual))):
            #        self.point_line_distance_actual = []
        ...
        #return self.point_line_distance_actual, mean_distance_of_line_from_center_line, line_points
