...
# file6= open("[PYTHON]Poin2_Y_control_body_frame.txt","w") 
    ...
    #Txt Files for debugging
# file1 = open("simulation_data/sim_data_complete/frame_received_and_analyzed_thermo.txt","w") 
# file2 = open("simulation_data/sim_data_complete/time_to_analyze_frame_thermo.txt","w") 
...
th_0 = 125.547 #125.547 #Reshape intensity pixels values 
th1 = [120, 180] #[110, 255] #[120, 180] #mask
# th1 = [20, 100]  #video
#th1 = [20, 90]
th2 = 14 #6#distance 
th3 =  5000 #5500 #4500 # 2000 area
th4 = 0.05  #epsilon aproxPolydp 
th5 = 0.2   #Magnitude for clustering value 
...
def load_image(photo_number):
     ...
     #name = '/home/lucamora/Desktop/DJI_0023_R.jpg'
...
def listener():
    ...
    parameters_optimization = True ##True if The param opt is available

    Matrice = rospy.get_param("/THERMO_params/Matrice")
    parameters_optimization = rospy.get_param("/THERMO_params/parameters_optimization")
    ...
    while(count < condition):
        ...
        # th_0 = rospy.get_param("/THERMO_params/th_0")
        # th1 = rospy.get_param("/THERMO_params/th1")
        # th2 = rospy.get_param("/THERMO_params/th2")
        # th3 = rospy.get_param("/THERMO_params/th3")
        # th4 = rospy.get_param("/THERMO_params/th4")
        # image_resize = rospy.get_param("/THERMO_params/image_resize")
